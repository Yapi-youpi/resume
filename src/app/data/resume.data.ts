...
export const resumeData: ResumeData = {
  ...
  aboutMe: `Frontend-разработчик с 5+ лет коммерческого опыта (Angular). Разрабатываю и поддерживаю SPA-приложения: проектирую архитектуру, создаю переиспользуемые компоненты и оптимизирую производительность. Работал с RxJS, REST API, авторизацией, формами высокой сложности, lazy-loading и сборкой production-окружений. Участвовал в code review, рефакторинге legacy-модулей и настройке деплоя (Firebase / CI). Ориентирован на чистую архитектуру, предсказуемую структуру проекта и долгосрочную поддержку продукта.`,
